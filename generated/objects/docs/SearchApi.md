...
func main() {
    ...
    resp, r, err := api_client.SearchApi.PostCrmV3ObjectsObjectTypeSearchDoSearch(context.Background(), objectType).PublicObjectSearchRequest(publicObjectSearchRequest).Execute()
    if err != nil {

...
*/
func (a *BasicApiService) Deletecrmv3objectsobjectTypeobjectIdArchive(ctx context.Context, objectType string, objectId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/{objectType}/{objectId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param objectType
 * @param optional nil or *BasicApiGetcrmv3objectsobjectTypeGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectsobjectTypeGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectsobjectTypeGetPage(ctx context.Context, objectType string, localVarOptionals *BasicApiGetcrmv3objectsobjectTypeGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/{objectType}"
	localVarPath = strings.Replace(localVarPath, "{"+"objectType"+"}", fmt.Sprintf("%v", objectType), -1)
 ...
 * @param objectType
 * @param objectId
 * @param optional nil or *BasicApiGetcrmv3objectsobjectTypeobjectIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectsobjectTypeobjectIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectsobjectTypeobjectIdGetById(ctx context.Context, objectType string, objectId string, localVarOptionals *BasicApiGetcrmv3objectsobjectTypeobjectIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param objectType
 * @param objectId
 * @param optional nil or *BasicApiPatchcrmv3objectsobjectTypeobjectIdUpdateOpts - Optional Parameters:
     * @param "IdProperty" (optional.String) -  The name of a property whose values are unique for this object type
@return SimplePublicObject
*/

type BasicApiPatchcrmv3objectsobjectTypeobjectIdUpdateOpts struct {
	IdProperty optional.String
}

func (a *BasicApiService) Patchcrmv3objectsobjectTypeobjectIdUpdate(ctx context.Context, body SimplePublicObjectInput, objectType string, objectId string, localVarOptionals *BasicApiPatchcrmv3objectsobjectTypeobjectIdUpdateOpts) (SimplePublicObject, *http.Response, error) {
	var (
...
@return SimplePublicObject
*/
func (a *BasicApiService) Postcrmv3objectsobjectTypeCreate(ctx context.Context, body SimplePublicObjectInput, objectType string) (SimplePublicObject, *http.Response, error) {
	var (

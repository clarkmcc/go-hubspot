...
/*
AssociationsGet List associations of a company by type
...
*/
func (a *AssociationsApiService) AssociationsGet(ctx context.Context, companyId string, toObjectType string) ApiAssociationsGetRequest {
	return ApiAssociationsGetRequest{
		ApiService:   a,
		ctx:          ctx,
		companyId:    companyId,

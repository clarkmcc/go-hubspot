...
*/
func (a *BasicApiService) Deletecrmv3objectscompaniescompanyIdArchive(ctx context.Context, companyId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/companies/{companyId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BasicApiGetcrmv3objectscompaniesGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectscompaniesGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectscompaniesGetPage(ctx context.Context, localVarOptionals *BasicApiGetcrmv3objectscompaniesGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/companies"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param companyId
 * @param optional nil or *BasicApiGetcrmv3objectscompaniescompanyIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectscompaniescompanyIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectscompaniescompanyIdGetById(ctx context.Context, companyId string, localVarOptionals *BasicApiGetcrmv3objectscompaniescompanyIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param body
 * @param companyId
 * @param optional nil or *BasicApiPatchcrmv3objectscompaniescompanyIdUpdateOpts - Optional Parameters:
     * @param "IdProperty" (optional.String) -  The name of a property whose values are unique for this object type
@return SimplePublicObject
*/

type BasicApiPatchcrmv3objectscompaniescompanyIdUpdateOpts struct {
	IdProperty optional.String
}

func (a *BasicApiService) Patchcrmv3objectscompaniescompanyIdUpdate(ctx context.Context, body SimplePublicObjectInput, companyId string, localVarOptionals *BasicApiPatchcrmv3objectscompaniescompanyIdUpdateOpts) (SimplePublicObject, *http.Response, error) {
	var (
...
@return SimplePublicObject
*/
func (a *BasicApiService) Postcrmv3objectscompaniesCreate(ctx context.Context, body SimplePublicObjectInput) (SimplePublicObject, *http.Response, error) {
	var (

...
func (r ApiPostCrmV3ObjectsFeedbackSubmissionsSearchDoSearchRequest) Execute() (CollectionResponseWithTotalSimplePublicObjectForwardPaging, *_nethttp.Response, error) {
...
*/
func (a *SearchApiService) PostCrmV3ObjectsFeedbackSubmissionsSearchDoSearch(ctx _context.Context) ApiPostCrmV3ObjectsFeedbackSubmissionsSearchDoSearchRequest {
	return ApiPostCrmV3ObjectsFeedbackSubmissionsSearchDoSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SearchApiService) PostCrmV3ObjectsFeedbackSubmissionsSearchDoSearchExecute(r ApiPostCrmV3ObjectsFeedbackSubmissionsSearchDoSearchRequest) (CollectionResponseWithTotalSimplePublicObjectForwardPaging, *_nethttp.Response, error) {
	var (

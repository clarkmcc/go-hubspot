 ...
 * @param optional nil or *BasicApiGetcrmv3objectsquotesGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectsquotesGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectsquotesGetPage(ctx context.Context, localVarOptionals *BasicApiGetcrmv3objectsquotesGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/quotes"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param quoteId
 * @param optional nil or *BasicApiGetcrmv3objectsquotesquoteIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectsquotesquoteIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectsquotesquoteIdGetById(ctx context.Context, quoteId string, localVarOptionals *BasicApiGetcrmv3objectsquotesquoteIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/quotes/{quoteId}"

...
*/
func (a *BasicApiService) Deletecrmv3objectscontactscontactIdArchive(ctx context.Context, contactId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/contacts/{contactId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BasicApiGetcrmv3objectscontactsGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectscontactsGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectscontactsGetPage(ctx context.Context, localVarOptionals *BasicApiGetcrmv3objectscontactsGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/contacts"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId
 * @param optional nil or *BasicApiGetcrmv3objectscontactscontactIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectscontactscontactIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectscontactscontactIdGetById(ctx context.Context, contactId string, localVarOptionals *BasicApiGetcrmv3objectscontactscontactIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param body
 * @param contactId
 * @param optional nil or *BasicApiPatchcrmv3objectscontactscontactIdUpdateOpts - Optional Parameters:
     * @param "IdProperty" (optional.String) -  The name of a property whose values are unique for this object type
@return SimplePublicObject
*/

type BasicApiPatchcrmv3objectscontactscontactIdUpdateOpts struct {
	IdProperty optional.String
}

func (a *BasicApiService) Patchcrmv3objectscontactscontactIdUpdate(ctx context.Context, body SimplePublicObjectInput, contactId string, localVarOptionals *BasicApiPatchcrmv3objectscontactscontactIdUpdateOpts) (SimplePublicObject, *http.Response, error) {
	var (
...
@return SimplePublicObject
*/
func (a *BasicApiService) Postcrmv3objectscontactsCreate(ctx context.Context, body SimplePublicObjectInput) (SimplePublicObject, *http.Response, error) {
	var (

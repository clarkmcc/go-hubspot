...
/*
SyncApiService Import contacts
...
*/
func (a *SyncApiService) Postcrmv3extensionsaccountingsyncappIdcontactsCreateContact(ctx context.Context, body SyncContactsRequest, appId int32) (ActionResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/extensions/accounting/sync/{appId}/contacts"
...
/*
SyncApiService Import products
...
@return ActionResponse
*/
func (a *SyncApiService) Postcrmv3extensionsaccountingsyncappIdproductsCreateProduct(ctx context.Context, body SyncProductsRequest, appId int32) (ActionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/extensions/accounting/sync/{appId}/products"
	localVarPath = strings.Replace(localVarPath, "{"+"appId"+"}", fmt.Sprintf("%v", appId), -1)

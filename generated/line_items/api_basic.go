...
*/
func (a *BasicApiService) Deletecrmv3objectslineItemslineItemIdArchive(ctx context.Context, lineItemId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/line_items/{lineItemId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BasicApiGetcrmv3objectslineItemsGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectslineItemsGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectslineItemsGetPage(ctx context.Context, localVarOptionals *BasicApiGetcrmv3objectslineItemsGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/line_items"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param lineItemId
 * @param optional nil or *BasicApiGetcrmv3objectslineItemslineItemIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectslineItemslineItemIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectslineItemslineItemIdGetById(ctx context.Context, lineItemId string, localVarOptionals *BasicApiGetcrmv3objectslineItemslineItemIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param body
 * @param lineItemId
 * @param optional nil or *BasicApiPatchcrmv3objectslineItemslineItemIdUpdateOpts - Optional Parameters:
     * @param "IdProperty" (optional.String) -  The name of a property whose values are unique for this object type
@return SimplePublicObject
*/

type BasicApiPatchcrmv3objectslineItemslineItemIdUpdateOpts struct {
	IdProperty optional.String
}

func (a *BasicApiService) Patchcrmv3objectslineItemslineItemIdUpdate(ctx context.Context, body SimplePublicObjectInput, lineItemId string, localVarOptionals *BasicApiPatchcrmv3objectslineItemslineItemIdUpdateOpts) (SimplePublicObject, *http.Response, error) {
	var (
...
@return SimplePublicObject
*/
func (a *BasicApiService) Postcrmv3objectslineItemsCreate(ctx context.Context, body SimplePublicObjectInput) (SimplePublicObject, *http.Response, error) {
	var (

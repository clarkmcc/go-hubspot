...
func (r ApiPostCrmV3ObjectsTicketsSearchDoSearchRequest) Execute() (CollectionResponseWithTotalSimplePublicObjectForwardPaging, *_nethttp.Response, error) {
...
*/
func (a *SearchApiService) PostCrmV3ObjectsTicketsSearchDoSearch(ctx _context.Context) ApiPostCrmV3ObjectsTicketsSearchDoSearchRequest {
	return ApiPostCrmV3ObjectsTicketsSearchDoSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SearchApiService) PostCrmV3ObjectsTicketsSearchDoSearchExecute(r ApiPostCrmV3ObjectsTicketsSearchDoSearchRequest) (CollectionResponseWithTotalSimplePublicObjectForwardPaging, *_nethttp.Response, error) {
	var (

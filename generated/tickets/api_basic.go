...
*/
func (a *BasicApiService) Deletecrmv3objectsticketsticketIdArchive(ctx context.Context, ticketId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/tickets/{ticketId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BasicApiGetcrmv3objectsticketsGetPageOpts - Optional Parameters:
...
type BasicApiGetcrmv3objectsticketsGetPageOpts struct {
...
func (a *BasicApiService) Getcrmv3objectsticketsGetPage(ctx context.Context, localVarOptionals *BasicApiGetcrmv3objectsticketsGetPageOpts) (CollectionResponseSimplePublicObjectWithAssociationsForwardPaging, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/crm/v3/objects/tickets"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId
 * @param optional nil or *BasicApiGetcrmv3objectsticketsticketIdGetByIdOpts - Optional Parameters:
     * @param "Properties" (optional.Interface of []string) -  A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
     * @param "Associations" (optional.Interface of []string) -  A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
     * @param "Archived" (optional.Bool) -  Whether to return only results that have been archived.
...
type BasicApiGetcrmv3objectsticketsticketIdGetByIdOpts struct {
	Properties   optional.Interface
	Associations optional.Interface
	Archived     optional.Bool
...
func (a *BasicApiService) Getcrmv3objectsticketsticketIdGetById(ctx context.Context, ticketId string, localVarOptionals *BasicApiGetcrmv3objectsticketsticketIdGetByIdOpts) (SimplePublicObjectWithAssociations, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param body
 * @param ticketId
 * @param optional nil or *BasicApiPatchcrmv3objectsticketsticketIdUpdateOpts - Optional Parameters:
     * @param "IdProperty" (optional.String) -  The name of a property whose values are unique for this object type
@return SimplePublicObject
*/

type BasicApiPatchcrmv3objectsticketsticketIdUpdateOpts struct {
	IdProperty optional.String
}

func (a *BasicApiService) Patchcrmv3objectsticketsticketIdUpdate(ctx context.Context, body SimplePublicObjectInput, ticketId string, localVarOptionals *BasicApiPatchcrmv3objectsticketsticketIdUpdateOpts) (SimplePublicObject, *http.Response, error) {
	var (
...
@return SimplePublicObject
*/
func (a *BasicApiService) Postcrmv3objectsticketsCreate(ctx context.Context, body SimplePublicObjectInput) (SimplePublicObject, *http.Response, error) {
	var (

...
func main() {
    ...
    resp, r, err := apiClient.GDPRApi.PostCrmV3ObjectsFeedbackSubmissionsGdprDeletePurge(context.Background()).PublicGdprDeleteInput(publicGdprDeleteInput).Execute()
    if err != nil {
